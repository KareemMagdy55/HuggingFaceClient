...
private static readonly HttpClient _httpClient = new HttpClient();
        ...
        where TResponse : class
    {
        try
        {
            ...
            requestMessage.Headers.Authorization = new AuthenticationHeaderValue("Bearer", HuggingFaceGlobalConfig.ApiToken);
            ...
            var parsed = JsonSerializer.Deserialize<TResponse>(content, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
        ...
        where TResponse : class
    {
        ...
        while (!reader.EndOfStream)
        {
            ...
            {
                parsed = JsonSerializer.Deserialize<TResponse>(line, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
            }
